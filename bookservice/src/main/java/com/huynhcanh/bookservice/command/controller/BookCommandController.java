package com.huynhcanh.bookservice.command.controller;
...
import com.huynhcanh.bookservice.command.model.BookRequestModel;
...
public class BookCommandController {
    ...
    public String addBook(@RequestBody BookRequestModel model) {
        ...
        commandGateway.sendAndWait(command); // phát ra event tạo book
        return "added Book";
    }
